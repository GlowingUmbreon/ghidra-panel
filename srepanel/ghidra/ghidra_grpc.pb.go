...
const (
	...
	Ghidra_GetRepository_FullMethodName     = "/ghidra.Ghidra/GetRepository"
	...
	Ghidra_DeleteRepository_FullMethodName  = "/ghidra.Ghidra/DeleteRepository"
)
...
type GhidraClient interface {
	...
	GetRepository(ctx context.Context, in *GetRepositoryRequest, opts ...grpc.CallOption) (*GetRepositoryReply, error)
...
func (c *ghidraClient) GetRepository(ctx context.Context, in *GetRepositoryRequest, opts ...grpc.CallOption) (*GetRepositoryReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRepositoryReply)
	err := c.cc.Invoke(ctx, Ghidra_GetRepository_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ghidraClient) DeleteRepository(ctx context.Context, in *DeleteRepositoryRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Ghidra_DeleteRepository_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GhidraServer interface {
	...
	GetRepository(context.Context, *GetRepositoryRequest) (*GetRepositoryReply, error)
...
// UnimplementedGhidraServer must be embedded to have
...
func (UnimplementedGhidraServer) GetRepository(context.Context, *GetRepositoryRequest) (*GetRepositoryReply, error) {
...
func (UnimplementedGhidraServer) DeleteRepository(context.Context, *DeleteRepositoryRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteRepository not implemented")
}
func (UnimplementedGhidraServer) mustEmbedUnimplementedGhidraServer() {}
func (UnimplementedGhidraServer) testEmbeddedByValue()                {}
...
func RegisterGhidraServer(s grpc.ServiceRegistrar, srv GhidraServer) {
	// If the following call pancis, it indicates UnimplementedGhidraServer was
...
func _Ghidra_GetRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRepositoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GhidraServer).GetRepository(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ghidra_GetRepository_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GhidraServer).GetRepository(ctx, req.(*GetRepositoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Ghidra_DeleteRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRepositoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GhidraServer).DeleteRepository(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ghidra_DeleteRepository_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GhidraServer).DeleteRepository(ctx, req.(*DeleteRepositoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Ghidra_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Ghidra_GetRepository_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Ghidra_DeleteRepository_Handler,
		},
	},
